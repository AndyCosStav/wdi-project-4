...
const Navbar = ({ history }) => {
  ...
  return(
    <nav>
      ...
      {Auth.isAuthenticated() && <Link to="/SearchFood" className="standard-button">Search Food</Link>}
      {Auth.isAuthenticated() && <Link to="/days" className="standard-button">Diary</Link>}
